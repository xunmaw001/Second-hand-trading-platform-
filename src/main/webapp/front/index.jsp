...
<html>
	...
	<style type="text/css">
		...
		#header .navs li.current {
			...
			background-color: rgba(255, 255, 255, 1);
			box-shadow: 5px 0 0px 2px #267379;
		}
			  ...
			  <div class="nav-top-tel"></div>
				...
				<div class="list">
					<ul>
						...
						<li v-if="chatFlag"><a href="javascript:chatTap()" class="menumain"><i v-if="false" class="layui-icon">&#xe677;</i>客服中心</a></li>
					</ul>
				</div>
		    </div>
