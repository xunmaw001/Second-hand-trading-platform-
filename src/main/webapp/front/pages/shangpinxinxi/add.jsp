			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.maijiazhanghao" type="text" :readonly="ro.maijiazhanghao" name="maijiazhanghao" id="maijiazhanghao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">卖家姓名：</label>
						<div class="layui-input-block">
							<input v-model="detail.maijiaxingming" type="text" :readonly="ro.maijiaxingming" name="maijiaxingming" id="maijiaxingming" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		...
		<script>
			...
			var vue = new Vue({
				...
				data: {
					...
					shangpinfenlei: [],
					chengse: '全新,九成新,八成新,八成新以下'.split(','),
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                form.on('select(chengse)', function (data) {
                    vue.detail.chengse=data.value;
                });
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					data = data.data
					for(var key in data){
                        if(key=='maijiazhanghao'){
                                vue.detail['maijiazhanghao'] = data[`${key}`]
                                vue.ro.maijiazhanghao = true;
                                continue;
                        }
                        if(key=='maijiaxingming'){
                                vue.detail['maijiaxingming'] = data[`${key}`]
                                vue.ro.maijiaxingming = true;
                                continue;
                        }
					}
				});
