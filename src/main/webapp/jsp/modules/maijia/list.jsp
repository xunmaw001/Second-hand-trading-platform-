					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>卖家列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">卖家列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										卖家账号
									</label>
									<input type="text" id="maijiazhanghaoSearch" class="form-control form-control-sm" placeholder="请输入卖家账号" aria-controls="tableId">
									<label>
										卖家姓名
									</label>
									<input type="text" id="maijiaxingmingSearch" class="form-control form-control-sm" placeholder="请输入卖家姓名" aria-controls="tableId">
