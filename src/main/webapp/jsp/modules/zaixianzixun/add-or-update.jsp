					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>在线咨询管理</span></li>
								<li class="breadcrumb-item active"><span>编辑在线咨询</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>成色</label>
										<input name="chengse" id="chengse" name="chengse" class="form-control" placeholder="成色">
									</div>
									<div class="form-group col-md-6">
										<label>咨询内容</label>
										<input name="zixunneirong" id="zixunneirong" name="zixunneirong" class="form-control" placeholder="咨询内容">
									</div>
									<div class="form-group col-md-6">
										<label>咨询日期</label>
									...
									<div class="form-group col-md-6">
										<label>卖家账号</label>
										<input name="maijiazhanghao" id="maijiazhanghao" name="maijiazhanghao" class="form-control" placeholder="卖家账号">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "zaixianzixun/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("zaixianzixun/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("zaixianzixun/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("zaixianzixun/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.maijiazhanghao != null && res.data.maijiazhanghao != ''){
						...
						$("#maijiazhanghao").attr('readonly','readonly');
					}
